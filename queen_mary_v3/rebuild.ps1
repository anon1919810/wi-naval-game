...
foreach ($qmName in @('HMS_Queen_Mary_1913_Refined_v3.blend','HMS_Queen_Mary_1913_Refined_v3.fbx')) {
...
& $BlenderExe --background (Join-Path $PSScriptRoot 'HMS_Queen_Mary_1913_Refined_v3.blend') --python-exit-code 1 --python (Join-Path $PSScriptRoot 'verify_blender.py')
