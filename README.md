...
## 当前状态 · 2026-09-19（A 阶段）

- **仓库**：`main@69ba5f6` → https://github.com/anon1919810/wi-naval-game
- **v4 外观**已接入 GameplayLab；**A01–A05 战斗正确性**测试 Edit 3/3、Play 5/5，独立播放器构建成功。
- **入口文档**：[交接_战斗正确性A_2026-09-19.md](交接_战斗正确性A_2026-09-19.md)（含全部地址与命令）
- 玩法仍为**即时射线**原型；B 阶段（炮口契约/装填/弹道）未做。

- [项目交接 · A 阶段与资产地址 · 2026-09-19](交接_战斗正确性A_2026-09-19.md)
